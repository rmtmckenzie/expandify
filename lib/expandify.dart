...
class Expandify extends StatelessWidget {
  ...
  const Expandify({super.key, required this.child, this.direction = Axis.vertical, this.padding});

  @override
  Widget build(BuildContext context) {
    switch (direction) {
      case Axis.vertical:
        return LayoutBuilder(builder: buildVertical);
      case Axis.horizontal:
        return LayoutBuilder(builder: buildHorizontal);
    }
  }

  Widget buildVertical(BuildContext context, BoxConstraints viewportConstraints) {
  ...
  Widget buildHorizontal(BuildContext context, BoxConstraints viewportConstraints) {
    return SingleChildScrollView(
